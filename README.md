...
You have to design & build the backend for the application and the ability for the users to register, rate books, browse books and check other information.
...
https://github.com/azaylamba/Goodreads 
